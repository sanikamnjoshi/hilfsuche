...
export default class ReplyView extends Component {
  ...
  onSubmit(e) {
    ...
    // axios.get('http://localhost:3000/auth/', this.props.match.params.id)
    // .then(response => {
    //   this.setState({
    ...
    // MailService.sendmail(this.state.toUser.userName ,this.state.toUser.email, this.state.toUser.subscribe);
        ...
        <Row className="justify-content-center">
          <Col xs={8}>
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <div className="form-group">
                <input type="submit" value="Send Reply" className="btn btn-primary" />
              </div>
